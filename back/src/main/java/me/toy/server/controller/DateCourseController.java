...
public class DateCourseController {
  ...
  @Secured("ROLE_USER")
  @PostMapping("/datecourse/{dateCourseId}/like")
  ...
  @Secured("ROLE_USER")
  @DeleteMapping("/datecourse/{dateCourseId}/unlike")
  ...
  public List<ThumbUpDateCourseDto> thumbUpDateCourseList() {
    return dateCourseService.getThumbUpDateCourseList();
  }
  ...
  @Secured("ROLE_USER")
  @PostMapping("/datecourse/{courseId}/comment")
